(function () {
  ...
  var options = {
    ...
    annotations: {
      ...
      points: [
        ...
        {
          x: new Date("08 Dec 2022").getTime(),
          y: 9340.85,
          marker: {
            size: 0,
          },
  ...
  var options = {
    series: [
      {
        data: generateDayWiseTimeSeries(new Date("11 Feb 2022").getTime(), 20, {
          min: 10,
          max: 60,
        }),
      },
  ...
  getDayWiseTimeSeries(new Date("11 Feb 2022 GMT").getTime(), 10, {
    min: 10,
    max: 90,
  });
