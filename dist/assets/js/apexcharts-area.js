(function () {
  ...
  var optionsYears = {
    ...
    chart: {
      ...
      selection: {
        enabled: true,
        xaxis: {
          min: new Date("26 Jan 2020").getTime(),
          max: new Date("29 Mar 2021").getTime(),
        },
      },
      zoom: {
        enabled: false,
  ...
  var options = {
    ...
    xaxis: {
      ...
      max: new Date("01/20/2020").getTime(),
      labels: {
        rotate: -15,
        rotateAlways: true,
  ...
  var chart = new ApexCharts(
    document.querySelector("#area-irregular"),
    options
  );
  chart.render();
  ...
  var options = {
    ...
    annotations: {
      ...
      xaxis: [
        {
          x: new Date("14 Nov 2018").getTime(),
          borderColor: "#999",
          yAxisIndex: 0,
          label: {
            show: true,
