...
(function () {
    ...
    option = {
        ...
        color: ["#8fbd56", "#e984b1", "#e7c354", "#59adec", "#d12c47"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["#8fbd56", "#e984b1", "#e7c354", "#d12c47"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["#8fbd56", "#e984b1", "#e7c354", "#d12c47", "#59adec"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        xAxis: {
            data: ['2022-10-24', '2022-10-25', '2022-10-26', '2022-10-27'],
            splitLine: {
                lineStyle: {
                    type: 'dashed',
                    color: "rgba(142, 156, 173,0.1)"
