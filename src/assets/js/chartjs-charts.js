(function () {
    ...
    const data = {
        ...
        datasets: [{
            ...
            backgroundColor: 'rgb(143,189,86)',
            borderColor: 'rgb(143,189,86)',
    ...
    const data4 = {
        ...
        datasets: [{
            ...
            data: [10, 20, 30, 40],
            borderColor: 'rgb(143,189,86)',
            backgroundColor: 'rgba(143,189,86, 0.2)'
        }, {
            type: 'line',
            label: 'Line Dataset',
            data: [50, 50, 50, 50],
            fill: false,
            borderColor: 'rgb(234,134,179)'
        }]
    };
    const config5 = {
        type: 'scatter',
    ...
    const data6 = {
        ...
        datasets: [{
            ...
            backgroundColor: 'rgba(143,189,86, 0.2)',
            borderColor: 'rgb(143,189,86)',
            pointBackgroundColor: 'rgb(143,189,86)',
            pointBorderColor: '#fff',
            pointHoverBackgroundColor: '#fff',
            pointHoverBorderColor: 'rgb(143,189,86)'
        }, {
            label: 'My Second Dataset',
            data: [28, 48, 40, 19, 96, 27, 100],
            fill: true,
            backgroundColor: 'rgba(234,134,179, 0.2)',
            borderColor: 'rgb(234,134,179)',
            pointBackgroundColor: 'rgb(234,134,179)',
            pointBorderColor: '#fff',
            pointHoverBackgroundColor: '#fff',
            pointHoverBorderColor: 'rgb(234,134,179)'
        }]
    };
    const config7 = {
        type: 'radar',
