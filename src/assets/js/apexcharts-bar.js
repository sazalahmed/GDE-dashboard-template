(function () {
  ...
  var options = {
    ...
    colors: ["#8fbd56", "#e984b1", "#e7c354", "#d12c47", "#59adec"],
    grid: {
      borderColor: "#f2f5f7",
    },
    title: {
    ...
    xaxis: {
      categories: [2008, 2015, 2016, 2017, 2018, 2019, 2020],
      labels: {
  ...
  var options = {
    ...
    title: {
      text: "Mauritius population pyramid 2017",
      align: "left",
      style: {
        fontSize: "13px",
        fontWeight: "bold",
  ...
  var options = {
    ...
    colors: ["#8fbd56", "#e984b1", "#e7c354", "#59adec"],
    title: {
