(function () {
  ...
  var options = {
    ...
    colors: ["#8fbd56", "#e984b1", "#e7c354", "#d12c47"],
    responsive: [
      {
        breakpoint: 480,
        options: {
  ...
  var chart = new ApexCharts(
    document.querySelector("#column-stacked-full"),
    options
  );
  chart.render();
  ...
  var chart = new ApexCharts(
    document.querySelector("#column-markers"),
    options
  );
  chart.render();
  ...
  var chart = new ApexCharts(
    document.querySelector("#column-rotated-labels"),
    options
  );
  chart.render();
  ...
  var chart = new ApexCharts(
    document.querySelector("#column-negative"),
    options
  );
  chart.render();
  ...
  var chart = new ApexCharts(
    document.querySelector("#columns-distributed"),
    options
  );
  chart.render();
})();
