...
var chartethCoin = new ApexCharts(document.querySelector("#widgetEtcoin"),options);
chartethCoin.render();
...
document.getElementById("widgetEtcoin2").innerHTML = "";
var chartethCoin = new ApexCharts(document.querySelector("#widgetEtcoin2"),options);
chartethCoin.render();
...
var options = {
    series: [{
        name: "Revenue",
        data: [55, 52, 56, 52, 55, 55, 58, 58, 53, 53, 55, 55]
    }],
    chart: {
        height: 188,
        type: "area",
